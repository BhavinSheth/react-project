...
const VideoHorizontal = () => {
  return (
    <Row className="py-2 m-1 videoHorizontal align-align-items-center">
      <Col xs={6} md={6} className="videoHorizontal__left">
        <img
          src="https://unsplash.com/photos/Eelegt4hFNc/download"
          className="videoHorizontal__thumbnail"
        ></img>
        <span className="videoHorizontal__duration">5:27</span>
      </Col>
      <Col xs={6} md={6} className="p-0 videoHorizontal__right">
        <p className="mb-1 videoHorizontal__title">title</p>
        <div className="videoHorizontal__details">
          <AiFillEye /> {numeral(2232423).format("0.a")} Views •
          {moment("2021-08-17").fromNow()}
        </div>
        ...
        ></img>
          <p className="mt-3">Channel Name</p>
        </div>
      </Col>
    </Row>
  );
